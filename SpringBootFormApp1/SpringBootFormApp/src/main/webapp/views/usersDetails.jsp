...
<p style="text-align:left">	<a href="getForm" class="btn btn-outline-secondary btn-lg" >AddUser</a> &nbsp;&nbsp;
	<a href="pagination?pn=1" class="btn btn-outline-warning btn-lg">User
		Data in Pagination</a></p>
...
<div class="card">
	...
	<h2 class="h2 text-center text-success">All Users List In Table
		...
		<div class="card-body">
	<table id="myTable"
		class="display dataTable table table-hover table-bordered">
		<thead>
			<tr>
				<th>S.NO.</th>
				<th>User Id</th>
