			...
			$('form[id="vehicleAdrr"]').validate({
					rules :{
						...
						messages : {
							...
							city : { valueNotEquals: "Please select a City Name!" },
							zip:{
...
<body>
	<div class="back">
		<div class="container">
			<h2 class="text-center h2 text-secondary">Vehicle Owner Address Form</h2>
			<form:form  id="vehicleAdrr" action="saveAddr" modelAttribute="ownerAddr"
