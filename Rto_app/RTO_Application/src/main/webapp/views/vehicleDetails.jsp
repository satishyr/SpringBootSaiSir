		...
		$(function() {
			$('form[id="vehicleDtls"]').validate({
					rules :{
						...
						mfdYear	: { valueNotEquals: "-1" },
						vehicleType :{valueNotEquals: "default"}
						},
						messages : {
							companyName : 'Please Enter CompanyName',
							mfdYear : { valueNotEquals: "Please select an Year!" },
							vehicleType : { valueNotEquals: "Please select an vehicle type!" }
						},
...
<body>
	<div class="back">
		<div class="container">
			...
			<form:form  id="vehicleDtls" action="/saveVehicleDtls" modelAttribute="vehicleDtls"
