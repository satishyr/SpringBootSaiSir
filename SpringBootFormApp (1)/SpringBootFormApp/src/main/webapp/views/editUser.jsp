...
<body>
	...
	<h1 class=" h1 text-info text-center">Update User  Details Page</h1>

	<form:form id="userForm" action="updateUser" method="post"
		cssClass="form-group" modelAttribute="user">
		
		<label class="h3 text-left text-secondary">Your User ID:</label>
		...
		<label class="h3 text-left text-secondary">Enter User
			Password:</label>
		<form:input path="pazzword" cssClass="form-control" />
		<br>
		...
		<input type="submit" value="Update User" class="btn btn-outline-success" />
	</form:form>	
<a href="getAllUsers" class="btn btn-outline-dark btn-lg">Get All users List</a>
<a href="pagination?pn=1" class="btn btn-outline-primary btn-lg">User Data in Pagination</a>		
</body>
